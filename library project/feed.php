...
<form method="post" action="feed.php">
    <div align="center">
        ...
        <input type="textarea" class="form-control" id="exampleInputPassword1" placeholder="" name="feedback" style="width:500px"><br>
        <button type="submit" name="feedsubmit">submit</button>
      </div>
    </div>  
</form>
    <?php
    if (isset($_POST['feedsubmit'])) {
         $saic=$_SESSION['usrname'];
         $feed=$_POST['feedback'];
      $query="INSERT INTO `feedback`(`username`, `feedback`) VALUES ('$saic','$feed') ";
