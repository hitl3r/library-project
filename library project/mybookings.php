...
require 'config.php';
  $un=$_SESSION['usrname'];
$sql= mysqli_query($con ,"SELECT * FROM bookings,bookdata WHERE bookings.username='$un' AND bookings.productid=bookdata.pid");?>
<h1 style="text-decoration: underline" align="center">YOUR BOOKINGS</h1>
<?php 
