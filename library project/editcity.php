...
<body>
    ...
    <form method="POST" action="editcity.php">
		<div class="col-md-5">
			<h2>Change Your City</h2>
			<div class="row">
  				<div class="col-xs-6 col-md-10">
    				<div href="#" class="thumbnail">
      				<div class="row">
      					<div class="col-md-12 font">
      						If you want to change the city associated with your Libraria customer account, you may do so below. Be sure to click the Save Changes button when you are done.
      					</div>
      				</div>
      				<br><br>
      				<div class="row">
      					<div class="col-md-3"><b>New City</b></div>
      				</div>
      				<br>
      				<div class="row">
      					<div class="col-md-5">
      						<input type="text" class="form-control" id="edxampleInputEmail1" placeholder="city" name="newusername" required>
      					</div>
      				</div>
      				</div>
  ...
  if(isset($_POST['submitsavechanges'])){
     ...
     if(mysqli_num_rows($query_run)==0){
      $query="update user_info set city='$newusername' where username='$sai'";
     $query_run = mysqli_query($con,$query);
     if ($query_run) {   
